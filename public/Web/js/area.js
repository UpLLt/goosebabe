...
function getCityBuy(val){
    ...
    newStr.push("<li onclick=\"getProvinceBuy()\" style=\"background-color:#fb821a; color:#fff;\">"+province[val].NAME+"</li>");
...
function getAreaBuy(val,val1){
    ...
    var newStr=new Array();
    newStr.push("<div class=\"dqld_div\"><ul>");
    newStr.push("<li onclick=\"getProvinceBuy()\" style=\"background-color:#fb821a; color:#fff;\">"+province[val1].NAME+"</li>");
    newStr.push("<li onclick=\"getCityBuy("+val1+")\" style=\"background-color:#f9943f; color:#fff; padding-left:10px;\">"+city[val].NAME+"</li>");
